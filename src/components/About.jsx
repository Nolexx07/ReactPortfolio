import aboutImg from "../assets/aboutsathvik.jpg"
        ...
        <div className="flex flex-wrap">
            ...
            className="w-full lg:w-1/2 lg:p-8">
                <div className="flex items-center justify-center">
                    <img className="rounded-2xl w-[300px] h-[400px] object-cover lg:-translate-x-0 lg:-translate-y-10" src={aboutImg} alt="about"/>
                </div>
            </motion.div>
            <motion.div 
            whileInView={{ opacity: 1, x: 0}}
